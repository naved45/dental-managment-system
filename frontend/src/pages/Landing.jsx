...
const testimonials = [
  { name: "Dr. Naved bagwan", role: "Clinic Owner", text: "Cut our front-desk paperwork in half. Everything from bookings to billing lives in one dashboard now." },
  { name: "ilyas bagwan", role: "Clinic Manager", text: "The analytics view finally gives us a clear picture of monthly revenue and pending payments." },
];
    ...
    <div className="bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 min-h-screen">
      <nav className="flex items-center justify-between px-6 md:px-16 py-5 border-b border-slate-100 dark:border-slate-800">
        ...
        <div className="space-x-3">
          <Link to="/login" className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-cyan-600">Login</Link>
